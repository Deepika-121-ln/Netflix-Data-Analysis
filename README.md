...
## Project Overview
This project examines the Netflix Movies and TV Shows dataset using SQL to reveal actionable insights about Netflix’s content library. The analysis emphasizes content types, genres, ratings, countries of origin, release years, and other trends relevant to business strategy.

## Objectives
Analyze Netflix’s catalog of movies and TV shows to identify trends in content releases over time, examine the distribution of ratings and genres, determine top contributing countries and directors, and address business questions with SQL-driven analysis.
